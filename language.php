...
<?php
    $field = array("language_id","name", "last_update");
...
<h3>
    <p class="a">
    <label><input type="checkbox"  name='field[]'  value="language_id" <?php echo (in_array('language_id',$field)) ?'checked':'' ?> > Inventory Id</label>
    ...
    <button class ="button1" onclick = "location.href='insert_language.php'">Insert</button>
              ...
              while($row = $result->fetch_assoc()) {                   
                  echo "<tr>";
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      echo '<td><a href="update_language.php"><button>Update</button></a>  <a href="language.php?language_id=' .$row["language_id"].'"><button>Delete</button></a> </td>';
                  }  
                  echo "</tr>";           
                }
...
if (isset($_GET['language_id'])){
    ...
    $delete = mysqli_query($conn,"DELETE FROM language WHERE language_id = '$language_id'");
